...
skills/
  ...
  workflow/    review-6-lens, review-comments, leave-it-cleaner, clean-comments, clean-names, clean-functions, clean-structure, slice-diff, smoke-verify, browser-automation-safety
docs/
